    ...
    (
      <div
        style={{
          ...
          padding: "84px", background: "linear-gradient(135deg,#4527A0,#5E35B1 55%,#7C4DFF)", color: "#FFFFFF",
        }}
      >
        <div style={{ fontSize: 30, color: "#B388FF", letterSpacing: 8, fontWeight: 700 }}>REZERVY</div>
        ...
        <div style={{ fontSize: 30, color: "#B388FF", marginTop: 30 }}>
