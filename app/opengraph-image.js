    ...
    (
      <div
        style={{
          ...
          padding: "84px", background: "linear-gradient(135deg,#241A10,#4A3620 55%,#2A1F12)", color: "#FDF8EF",
        }}
      >
        <div style={{ fontSize: 30, color: "#E2BB88", letterSpacing: 8, fontWeight: 700 }}>REZERVY</div>
        ...
        <div style={{ fontSize: 30, color: "#D9BE97", marginTop: 30 }}>
