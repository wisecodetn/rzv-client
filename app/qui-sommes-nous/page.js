...
export default function QuiSommesNous() {
  return (
    ...
    >
      ...
      <div style={{ background: "linear-gradient(140deg,#3A2B1A,#6B4E2E)", borderRadius: 20, padding: "30px 28px", marginTop: 34, textAlign: "center", color: "#F8F0E2" }}>
        <div className="serif" style={{ fontSize: 22 }}>Vous gérez un salon ?</div>
        <div style={{ fontSize: 14, color: "#D9BE97", marginTop: 8, maxWidth: 460, marginLeft: "auto", marginRight: "auto", lineHeight: 1.6 }}>Rejoignez Rezervy Pro et développez votre activité — dès 49 TND/mois.</div>
